        ...
        <div class="container-xl wide-xl">
            <div class="nk-content-body ">
                ...
                <div class="nk-block-head nk-block-head-sm">
                    ...
                    <div class="nk-block-between">
                        <div class="nk-block-head-content">
                            <h3 class="nk-block-title page-title">دسته بندی {{ $category->slug }} ویرایش</h3>
                        </div>
                ...
                <div class="form create">
                    <form action="{{ route('admin.content.category.update', $category->slug) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" name="name" class="form-control" id="name_category"
                                    placeholder="مثال:اقتصادی" value="{{ old('name', $category->name) }}">
                            </div>
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="file" class="form-control" name="image" accept=".jpg, .png, .jpeg, .gif "
                                    id="image_category" placeholder="سلامت">
                            </div>
