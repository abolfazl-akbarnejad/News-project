            ...
            <div class="nk-content-body ">
                <nav class="mb-3">
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.menu.index') }}">پست ها</a></li>
                                    ...
                                    <ul class="nk-block-tools g-3">
                                        ...
                                        <li class="nk-block-tools-opt">
                                            <a href="{{ route('admin.content.post.create') }}"
                                                class=" btn btn-primary   "><em class="icon ni ni-plus"></em><span>ساخت پست
                                                    جدید</span></a>
                                        </li>
                                    </ul>
                                </div>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">تاریخ ایجاد / تاریخ انتشار</th>
