                    ...
                    <ul class="nk-menu nk-menu-main">
                        <li class="nk-menu-item has-sub">
                            <a href="#" class="nk-menu-link nk-menu-toggle">
                                <span class="nk-menu-text">داشبوردها</span>
                            </a>
                        ...
                        <li class="nk-menu-item">
                            <a href="./components.html" class="nk-menu-link">
                                <span class="nk-menu-text">کامپوننت ها</span>
                            </a>
                        </li>
                        <!-- .nk-menu-item -->
                    </ul>
                    ...
                    <li class="dropdown chats-dropdown hide-mb-sm">
                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                ...
                                <ul class="chat-list">
                                        ...
                                        <a class="chat-link" href="./apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                ...
                                                <div class="chat-context">
                                                    <div class="text">شما: لطفا اگه آخرین پیام های من
                                                        رو
                                                        دریافت کردید، تایید کنید.</div>
                                    ...
                                    <li class="chat-item is-unread">
                                        <a class="chat-link" href="./apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                <div class="chat-from">
                                                    <div class="name">فرشید ترنیان</div>
                                                    <span class="time">4:49 صبح</span>
                                                </div>
                                                <div class="chat-context">
                                                    <div class="text">سلام، من ترنیان هستم، می تونید
                                                        در
                                                        حل این مشکل به من کمک کنید؟</div>
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="./apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                <div class="chat-from">
                                                    <div class="name">دانیال فراهانی</div>
                                                    <span class="time">17 فروردین</span>
                                                </div>
                                                <div class="chat-context">
                                                    <div class="text">ادعای مونا رو دیدید؟</div>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="./apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                <div class="chat-from">
                                                    <div class="name">گروه سافت نیو</div>
                                                    <span class="time">7 فروردین</span>
                                                </div>
                                                <div class="chat-context">
                                                    <div class="text">شما: من به تازگی یک کامپیوتر
                                                        جدید
                                                        خریدم اما مشکلی دارم</div>
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="./apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                <div class="chat-from">
                                                    <div class="name">کامران گودرزی</div>
                                                    <span class="time">14 فروردین</span>
                                                </div>
                                                <div class="chat-context">
                                                    <div class="text">سلام سامان! حالت چطوره؟</div>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li class="chat-item">
                                        <a class="chat-link" href="./apps-chats.html">
                                            ...
                                            <div class="chat-info">
                                                <div class="chat-from">
                                                    <div class="name">محمدرضا نیازی</div>
                                                    <span class="time">7 فروردین</span>
                                                </div>
                                                <div class="chat-context">
                                                    <div class="text">شما: من به تازگی یک کامپیوتر
                            ...
                            <div class="dropdown-foot center">
                                <a href="./apps-chats.html">مشاهده همه</a>
                            </div>
                        </div>
                    </li>
                                ...
                                <div class="nk-notification">
                                    <div class="nk-notification-item dropdown-inner">
                                        ...
                                        <div class="nk-notification-content">
                                            <div class="nk-notification-text">مهرداد
                                                <span>Dashlite-v2</span> را با شما به اشتراک گذاشت.
                                            </div>
                                    ...
                                    <div class="nk-notification-item dropdown-inner">
                                        ...
                                        <div class="nk-notification-content">
                                            <div class="nk-notification-text">مهرداد شما را به ویرایش
                                                پوشه <span>DashLite</span> <span>دعوت</span> کرد</div>
                                    ...
                                    <div class="nk-notification-item dropdown-inner">
                                        ...
                                        <div class="nk-notification-content">
                                            <div class="nk-notification-text">شما <span>پروژه نسخه
                                                    2</span> را با مجید به اشتراک گذاشتید.</div>
                                    ...
                                    <div class="nk-notification-item dropdown-inner">
                                        ...
                                        <div class="nk-notification-content">
                                            <div class="nk-notification-text"><span>اشتراک</span> شما
                                                با
                                                موفقیت تمدید شد.</div>
                    ...
                    <li class="dropdown language-dropdown d-none d-sm-block me-n1">
                        <a href="#" class="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                            <div class="quick-icon border border-light">
                                <img class="icon" src="images/iran-sq.png" alt="">
                            </div>
                        </a>
                            ...
                            <ul class="language-list">
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="images/iran.png" alt="" class="language-flag">
                                        <span class="language-name">فارسی</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="images/english.png" alt="" class="language-flag">
                                        <span class="language-name">انگلیسی</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="images/germany.png" alt="" class="language-flag">
                                        <span class="language-name">آلمانی</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#" class="language-item">
                                        <img src="images/french.png" alt="" class="language-flag">
                                ...
                                <ul class="link-list">
                                    <li>
                                        <a href="./user-profile-regular.html"><em
                                                class="icon ni ni-user-alt"></em><span>مشاهده
                                                پروفایل</span></a>
                                    </li>
                                    <li>
                                        <a href="./user-profile-setting.html"><em
                                                class="icon ni ni-setting-alt"></em><span>تنظیمات
                                                حساب</span></a>
                                    </li>
                                    <li>
                                        <a href="./user-profile-activity.html"><em
                                                class="icon ni ni-activity-alt"></em><span>فعالیت
                                                ورود</span></a>
                                    </li>
                                </ul>
                            </div>
